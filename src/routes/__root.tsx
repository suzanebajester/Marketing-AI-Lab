...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Go from idea to campaign in minutes. Answer six questions and get a complete marketing campaign tailored to your audience, offer, goals, and brand voice." },
      { property: "og:title", content: "Marketing AI Lab — AI Marketing Campaigns in Minutes" },
      { name: "twitter:title", content: "Marketing AI Lab — AI Marketing Campaigns in Minutes" },
      { property: "og:description", content: "Go from idea to campaign in minutes. Answer six questions and get a complete marketing campaign tailored to your audience, offer, goals, and brand voice." },
      { name: "twitter:description", content: "Go from idea to campaign in minutes. Answer six questions and get a complete marketing campaign tailored to your audience, offer, goals, and brand voice." },
